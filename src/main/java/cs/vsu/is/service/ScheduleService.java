...
import cs.vsu.is.service.convertor.ScheduleConverter;
...
public class ScheduleService {
  ...
  private final ScheduleConverter scheduleMapper;
  ...
  public List<ScheduleDTO> findAll() {
    ...
    return scheduleRepository.findAll().stream().map(scheduleMapper::toDto)
