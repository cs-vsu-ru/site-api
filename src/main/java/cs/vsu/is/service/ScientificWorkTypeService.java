...
public class ScientificWorkTypeService {
    ...
    private final ScientificWorkTypeMapper scientificWorkTypeMapper;

    public ScientificWorkTypeService(
        ScientificWorkTypeRepository scientificWorkTypeRepository,
        ScientificWorkTypeMapper scientificWorkTypeMapper
    ) {
        this.scientificWorkTypeRepository = scientificWorkTypeRepository;
        this.scientificWorkTypeMapper = scientificWorkTypeMapper;
    }
     ...
     * @return the persisted entity.
     */
    public Optional<ScientificWorkTypeDTO> partialUpdate(ScientificWorkTypeDTO scientificWorkTypeDTO) {
        log.debug("Request to partially update ScientificWorkType : {}", scientificWorkTypeDTO);

        return scientificWorkTypeRepository
            .findById(scientificWorkTypeDTO.getId())
            .map(existingScientificWorkType -> {
                scientificWorkTypeMapper.partialUpdate(existingScientificWorkType, scientificWorkTypeDTO);
