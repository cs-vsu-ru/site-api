...
import cs.vsu.is.service.convertor.EduSchedulePlaceConverter;
...
public class EduSchedulePlaceService {
  ...
  private final EduSchedulePlaceConverter eduSchedulePlaceMapper;

  public EduSchedulePlaceService(EduSchedulePlaceRepository eduSchedulePlaceRepository,
      EduSchedulePlaceConverter eduSchedulePlaceMapper) {
   ...
   * @return the persisted entity.
   */
  // public Optional<EduSchedulePlaceDTO> partialUpdate(EduSchedulePlaceDTO
  // eduSchedulePlaceDTO) {
  // log.debug("Request to partially update EduSchedulePlace : {}",
  // eduSchedulePlaceDTO);

  // return eduSchedulePlaceRepository
  // .findById(eduSchedulePlaceDTO.getId())
  // .map(existingEduSchedulePlace -> {
  // eduSchedulePlaceMapper.partialUpdate(existingEduSchedulePlace,
  // eduSchedulePlaceDTO);
