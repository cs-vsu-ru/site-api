...
public class LessonResource {
   ...
   *         body the new lessonDTO, or with status {@code 400 (Bad Request)} if
   *         the lesson has already an ID.
  ...
  public ResponseEntity<LessonDTO> updateLesson(
      ...
      @RequestBody LessonDTO lessonDTO) throws URISyntaxException {
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
   *         the lessonDTO, or with status {@code 404 (Not Found)}.
   */
