...
public class AccessModesResource {
   ...
   *         body the new accessModesDTO, or with status {@code 400 (Bad Request)}
   *         if the accessModes has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/access-modes")
  public ResponseEntity<AccessModeDTO> createAccessModes(@RequestBody AccessModeDTO accessModesDTO)
    ...
    AccessModeDTO result = accessModesService.save(accessModesDTO);
   ...
   *         the updated accessModesDTO,
   *         or with status {@code 400 (Bad Request)} if the accessModesDTO is not
   *         valid,
   *         or with status {@code 500 (Internal Server Error)} if the
   *         accessModesDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/access-modes/{id}")
  public ResponseEntity<AccessModeDTO> updateAccessModes(
      @PathVariable(value = "id", required = false) final Long id,
      @RequestBody AccessModeDTO accessModesDTO) throws URISyntaxException {
    ...
    AccessModeDTO result = accessModesService.update(accessModesDTO);
    return ResponseEntity
        .ok()
        .headers(
  ...
  /**
   * {@code PATCH  /access-modes/:id} : Partial updates given fields of an
   * existing accessModes, field will ignore if it is null
   *
   * @param id             the id of the accessModesDTO to save.
   * @param accessModesDTO the accessModesDTO to update.
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
   ...
   *         or with status {@code 400 (Bad Request)} if the accessModesDTO is not
   *         valid,
   *         or with status {@code 404 (Not Found)} if the accessModesDTO is not
   *         found,
   *         or with status {@code 500 (Internal Server Error)} if the
   *         accessModesDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  // @PatchMapping(value = "/access-modes/{id}", consumes = { "application/json",
  // "application/merge-patch+json" })
  // public ResponseEntity<AccessModeDTO> partialUpdateAccessModes(
  // @PathVariable(value = "id", required = false) final Long id,
  // @RequestBody AccessModeDTO accessModesDTO
  // ) throws URISyntaxException {
  // log.debug("REST request to partial update AccessModes partially : {}, {}",
  // id, accessModesDTO);
  // if (accessModesDTO.getId() == null) {
  // throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
  // }
  ...
  // Optional<AccessModeDTO> result =
  // accessModesService.partialUpdate(accessModesDTO);

  // return ResponseUtil.wrapOrNotFound(
  // result,
  // HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME,
  // accessModesDTO.getId().toString())
  // );
  // }
   ...
   *         of accessModes in body.
   */
  @GetMapping("/access-modes")
  public List<AccessModeDTO> getAllAccessModes() {
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
   *         the accessModesDTO, or with status {@code 404 (Not Found)}.
   */
  @GetMapping("/access-modes/{id}")
  public ResponseEntity<AccessModeDTO> getAccessModes(@PathVariable Long id) {
    log.debug("REST request to get AccessModes : {}", id);
    Optional<AccessModeDTO> accessModesDTO = accessModesService.findOne(id);
