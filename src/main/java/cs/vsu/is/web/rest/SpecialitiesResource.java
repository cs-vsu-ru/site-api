...
public class SpecialitiesResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new specialitiesDTO, or with status {@code 400 (Bad Request)} if the specialities has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/specialities")
    public ResponseEntity<SpecialitiesDTO> createSpecialities(@RequestBody SpecialitiesDTO specialitiesDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated specialitiesDTO,
     * or with status {@code 400 (Bad Request)} if the specialitiesDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the specialitiesDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<SpecialitiesDTO> updateSpecialities(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, specialitiesDTO.getId().toString()))
            .body(result);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated specialitiesDTO,
     * or with status {@code 400 (Bad Request)} if the specialitiesDTO is not valid,
     * or with status {@code 404 (Not Found)} if the specialitiesDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the specialitiesDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<SpecialitiesDTO> partialUpdateSpecialities(
        ...
        log.debug("REST request to partial update Specialities partially : {}, {}", id, specialitiesDTO);
        if (specialitiesDTO.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(id, specialitiesDTO.getId())) {
        ...
        Optional<SpecialitiesDTO> result = specialitiesService.partialUpdate(specialitiesDTO);
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the specialitiesDTO, or with status {@code 404 (Not Found)}.
     */
