...
public class ScientificWorkTypeResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new scientificWorkTypeDTO, or with status {@code 400 (Bad Request)} if the scientificWorkType has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/scientific-work-types")
    public ResponseEntity<ScientificWorkTypeDTO> createScientificWorkType(@RequestBody ScientificWorkTypeDTO scientificWorkTypeDTO)
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated scientificWorkTypeDTO,
     * or with status {@code 400 (Bad Request)} if the scientificWorkTypeDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the scientificWorkTypeDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<ScientificWorkTypeDTO> updateScientificWorkType(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, scientificWorkTypeDTO.getId().toString()))
            .body(result);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated scientificWorkTypeDTO,
     * or with status {@code 400 (Bad Request)} if the scientificWorkTypeDTO is not valid,
     * or with status {@code 404 (Not Found)} if the scientificWorkTypeDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the scientificWorkTypeDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<ScientificWorkTypeDTO> partialUpdateScientificWorkType(
        ...
        log.debug("REST request to partial update ScientificWorkType partially : {}, {}", id, scientificWorkTypeDTO);
        if (scientificWorkTypeDTO.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(id, scientificWorkTypeDTO.getId())) {
        ...
        Optional<ScientificWorkTypeDTO> result = scientificWorkTypeService.partialUpdate(scientificWorkTypeDTO);

        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, scientificWorkTypeDTO.getId().toString())
        );
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the scientificWorkTypeDTO, or with status {@code 404 (Not Found)}.
     */
