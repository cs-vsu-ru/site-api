...
// userService.requestPasswordReset("invalid.login@localhost");
...
// @Transactional
// void
// assertThatNotActivatedUsersWithNotNullActivationKeyCreatedBefore3DaysAreDeleted()
// {
...
// @Transactional
// void
// assertThatNotActivatedUsersWithNullActivationKeyCreatedBefore3DaysAreNotDeleted()
// {
// Instant now = Instant.now();
// when(dateTimeProvider.getNow()).thenReturn(Optional.of(now.minus(4,
// ChronoUnit.DAYS)));
