...
// // jhipster-needle-i18n-language-constant - JHipster will add/remove
// languages in this array
// };
// private static final Pattern PATTERN_LOCALE_3 =
// Pattern.compile("([a-z]{2})-([a-zA-Z]{4})-([a-z]{2})");
// private static final Pattern PATTERN_LOCALE_2 =
...
// assertThat(message.getDataHandler().getContentType()).isEqualTo("text/plain;
// charset=UTF-8");
// }
...
// MimeBodyPart part = (MimeBodyPart) ((MimeMultipart)
// mp.getBodyPart(0).getContent()).getBodyPart(0);
...
// assertThat(part.getDataHandler().getContentType()).isEqualTo("text/plain;
// charset=UTF-8");
// }
...
// assertThat(message.getFrom()[0]).hasToString(jHipsterProperties.getMail().getFrom());
// assertThat(message.getContent().toString()).isEqualToNormalizingNewlines("<html>test
// title, http://127.0.0.1:8080, john</html>\n");
// assertThat(message.getDataHandler().getContentType()).isEqualTo("text/html;charset=UTF-8");
// }
