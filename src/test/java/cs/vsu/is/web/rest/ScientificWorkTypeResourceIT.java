...
// /**
// * Integration tests for the {@link ScientificWorkTypeResource} REST
// controller.
// */
// @IntegrationTest
...
// @Mock
// private ScientificWorkTypeRepository scientificWorkTypeRepositoryMock;
...
// ScientificWorkType scientificWorkType = new
// ScientificWorkType().name(DEFAULT_NAME);
...
// ScientificWorkType scientificWorkType = new
// ScientificWorkType().name(UPDATED_NAME);
// return scientificWorkType;
// }
...
// .perform(
// post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(scientificWorkType))
// )
// .andExpect(status().isCreated());

// // Validate the ScientificWorkType in the database
// List<ScientificWorkType> scientificWorkTypeList =
// scientificWorkTypeRepository.findAll();
// assertThat(scientificWorkTypeList).hasSize(databaseSizeBeforeCreate + 1);
// ScientificWorkType testScientificWorkType =
// scientificWorkTypeList.get(scientificWorkTypeList.size() - 1);
...
// void getAllScientificWorkTypesWithEagerRelationshipsIsEnabled() throws
// Exception {
// when(scientificWorkTypeRepositoryMock.findAllWithEagerRelationships(any())).thenReturn(new
// PageImpl(new ArrayList<>()));

// restScientificWorkTypeMockMvc.perform(get(ENTITY_API_URL +
// "?eagerload=true")).andExpect(status().isOk());

// verify(scientificWorkTypeRepositoryMock,
// times(1)).findAllWithEagerRelationships(any());
// }

// @SuppressWarnings({ "unchecked" })
// void getAllScientificWorkTypesWithEagerRelationshipsIsNotEnabled() throws
// Exception {
// when(scientificWorkTypeRepositoryMock.findAllWithEagerRelationships(any())).thenReturn(new
// PageImpl(new ArrayList<>()));
...
// verify(scientificWorkTypeRepositoryMock,
// times(1)).findAll(any(Pageable.class));
// }
...
// // Get the scientificWorkType
// restScientificWorkTypeMockMvc.perform(get(ENTITY_API_URL_ID,
...
// ScientificWorkType updatedScientificWorkType =
// scientificWorkTypeRepository.findById(scientificWorkType.getId()).get();
// // Disconnect from session so that the updates on updatedScientificWorkType
...
// restScientificWorkTypeMockMvc
// .perform(
// put(ENTITY_API_URL_ID, updatedScientificWorkType.getId())
// .contentType(MediaType.APPLICATION_JSON)
// .content(TestUtil.convertObjectToJsonBytes(updatedScientificWorkType))
// )
// .andExpect(status().isOk());
...
// restScientificWorkTypeMockMvc
// .perform(
// put(ENTITY_API_URL_ID, scientificWorkType.getId())
// .contentType(MediaType.APPLICATION_JSON)
// .content(TestUtil.convertObjectToJsonBytes(scientificWorkType))
// )
// .andExpect(status().isBadRequest());
...
// restScientificWorkTypeMockMvc
// .perform(
// put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(scientificWorkType))
// )
...
// ScientificWorkType partialUpdatedScientificWorkType = new
// ScientificWorkType();
...
// restScientificWorkTypeMockMvc
// .perform(
// patch(ENTITY_API_URL_ID, scientificWorkType.getId())
// .contentType("application/merge-patch+json")
// .content(TestUtil.convertObjectToJsonBytes(scientificWorkType))
// )
// .andExpect(status().isBadRequest());
...
// scientificWorkType.getId()).accept(MediaType.APPLICATION_JSON))
